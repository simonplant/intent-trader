...
class MarketDataSchema(BaseModel):
    ...
    @field_validator("price", "change", "change_percent", "high", "low")
    @classmethod
...
class TradeSchema(BaseModel):
    """Schema for trade data exchange between agents"""
    ...
    def validate_status(cls, v):
        if v not in ["open", "closed", "cancelled"]:
            raise ValueError("Status must be one of: open, closed, cancelled")
        return v
