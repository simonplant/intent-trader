...
class PerformanceVisualizer:
    ...
    def plot_win_rate_by_symbol(self) -> Optional[Figure]:
        ...
        # Add win rates
        fig.add_trace(go.Bar(x=symbols, y=win_rates, name="Win Rate %", marker_color="blue"))
    ...
    def plot_strategy_performance(self) -> Optional[Figure]:
        ...
        # Add win rates
        fig.add_trace(
            go.Bar(x=strategies, y=win_rates, name="Win Rate %", marker_color="blue"),
            secondary_y=False,
        )
    ...
    def plot_trade_duration(self) -> Optional[Figure]:
        ...
        # Add histogram
        fig.add_trace(
            go.Histogram(x=durations, name="Trade Duration", marker_color="blue", nbinsx=20)
        )
    ...
    def plot_execution_quality(self) -> Optional[Figure]:
        ...
        fig.add_trace(go.Box(y=execution_quality, name="Execution Quality", marker_color="blue"))

        # Add plan adherence
        fig.add_trace(go.Box(y=plan_adherence, name="Plan Adherence", marker_color="green"))
