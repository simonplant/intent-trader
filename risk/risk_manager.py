...
class RiskManager:
    ...
    def calculate_position_size(self, symbol: str, entry_price: float, 
        ...
        max_risk_amount = self.risk_parameters.account_value * self.risk_parameters.max_position_risk
    ...
    def validate_trade(self, symbol: str, quantity: float, entry_price: float,
