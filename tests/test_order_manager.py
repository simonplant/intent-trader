...
def test_order_parameters_validation():
    ...
    with pytest.raises(ValueError):
        OrderParameters(symbol="ES", side="invalid", quantity=1.0, order_type="market")

    # Test invalid order type
    with pytest.raises(ValueError):
        OrderParameters(symbol="ES", side="buy", quantity=1.0, order_type="invalid")
...
def test_position_updates(order_manager, sample_market_data):
    ...
    params = OrderParameters(symbol="ES", side="sell", quantity=1.0, order_type="market")
